<img src="https://og.sznm.dev/api/generate?heading=single-page-game-app&text=Next.js+template+with+Chakra-UI+and+TypeScript+setup.&template=color&center=true&height=330" />
